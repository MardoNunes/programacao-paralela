...
{
    //TENTAR PARALELIZAR PARA ENCONTRAR O MAIOR COMUM SUFIXO E PREFIXO
    ...
    standard_output << "Maior string com o sufixo a prefixo B: " << x << "\n\n";
...
{
    //TENTAR PARALELIZAR ESSA CRIAÇÂO DE PARES PARA O CONJUNTO
